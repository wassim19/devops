...
public class StockServiceImpl implements IStockService {
	...
	public String retrieveStatusStock() {
		...
		for (int i = 0; i < stocksEnRouge.size(); i++) {
			bld.append(newLine+finalMessage+ msgDate + newLine + ": le stock "+ stocksEnRouge.get(i).getLibelleStock() + " a une quantité de " + stocksEnRouge.get(i).getQte()+ " inférieur à la quantité minimale a ne pas dépasser de " + stocksEnRouge.get(i).getQteMin()+ newLine);
